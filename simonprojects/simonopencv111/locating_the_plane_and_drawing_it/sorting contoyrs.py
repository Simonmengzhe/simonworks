...
while (1):
    ...
    _, mask0 = finding_blue.detect_finger_by_hsv(frameunblurred0, lower_black, upper_black)
    ...
    _, mask1 = finding_blue.detect_finger_by_hsv(frameunblurred1, lower_black, upper_black)
    ...
    if contours0 is not None:
        ...
        corners0 = cv2.goodFeaturesToTrack(mask0, 4, 0.01, 20)
        ...
        corners1 = cv2.goodFeaturesToTrack(mask0, 4, 0.01, 20)

...
while (1):
    ...
    res0, mask0 = finding_blue.detect_finger_by_hsv(frameunblurred0, lower_black, upper_black)
    ...
    res1, mask1 = finding_blue.detect_finger_by_hsv(frameunblurred1, lower_black, upper_black)
    ...
    if contours0 is not None:
        ...
        points0  = finding_blue.detect_finger_by_contours(mask0)
        points1 = finding_blue.detect_finger_by_contours(mask1)
        print(points0)
        # cnt1 = contours1[0]
        # cnt0 = contours0[0]
        ...
        #
        leftmost0 = points0[0]
        rightmost0 = points0[1]
        topmost0 = points0[2]
        bottommost0 = points0[4]
        #
        ...
        #
        leftmost1 = points1[0]
        rightmost1 = points1[1]
        topmost1 = points1[2]
        bottommost1 = points1[3]
